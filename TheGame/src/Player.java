...
public class Player extends GameObject {
	...
	public Player() {
		super(Game.WIDTH / 2 - 32, Game.HEIGHT / 2 - 32, ID.Player); // initialize player in the center of the screen.
		try {
		...
		try {
			player_image_right = ImageIO.read(new File("resources/Player_Sprite_Right.png")); // load player right sprite.
		} catch (IOException e) {
			e.printStackTrace();
		}
