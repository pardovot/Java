...
public class FollowingEnemy extends GameObject {
	...
	public FollowingEnemy(Player player) {
		super((int) (Math.random() * (Game.WIDTH - 64) + 1), (int) (Math.random() * (Game.HEIGHT - 64) + 1),
				ID.FollowingEnemy, Color.BLUE); // creates following enemy at random X and random Y
		this.player = player;
	}
	...
	public void followPlayer() { // calculates the directions between following enemy and the player, and adjusts
									// the X and Y according to it.
	...
	public Rectangle getBounds() { // returns a rectangle of the enemy object.
