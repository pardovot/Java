...
public class KeyInput extends KeyAdapter {
	...
	public KeyInput(Handler handler, Game game, Player player, basicEnemy basicEnemy, FollowingEnemy followingEnemy) {
	...
	public void keyPressed(KeyEvent e) {
		...
		if (game.gameState == STATE.Menu || game.gameState == STATE.GameOver) { // starts the game if pressed 'space' on
																				// the menu.
