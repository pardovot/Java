...
public class GoldenScore extends GameObject {
	...
	public GoldenScore() {
		super((int) (Math.random() * (Game.WIDTH-64) + 1), (int) (Math.random() * (Game.HEIGHT-64) + 1), ID.GoldenScore); // creates score object at random X and random Y
	...
	public Rectangle getBounds() { // returns a rectangle of the score object.
